---
title: Welcome to ayushG.com
description: A minimal, pixel-perfect dev portfolio, shadcn registry, and blog to showcase my work as a Design Engineer.
image: https://assets.chanhdai.com/images/screenshot-og-image-dark.png?v=8
...
Licensed under the [MIT license](https://github.com/ayushG19/ayushG19/blob/main/LICENSE).

The source code is available on [GitHub](https://github.com/ayushG19/ayushG19). You're free to use my code! Just make sure to remove all my personal information before publishing your website. It's awesome to see my code being useful to someone!
