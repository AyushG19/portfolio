...
Reference: https://github.com/ayush/ayush.zsh-theme

```bash
git clone git@github.com:ayush/ayush.zsh-theme.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/ayush.zsh-theme
```

**Activate the theme**

```bash title="~/.zshrc"
ZSH_THEME="ayush.zsh-theme/ayush"
```
