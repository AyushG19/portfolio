...
<ComponentPreview
  ...
  openInV0Url="https://ayushG.com/r/wheel-picker.json"
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.ayushG.com).
...
See the [React Wheel Picker](https://react-wheel-picker.ayushG.com/docs/getting-started) documentation for more information.
