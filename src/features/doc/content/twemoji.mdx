...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://ayushG.com/r/twemoji.json"
/>
...
[lib/twemoji-regex.ts](https://github.com/ayushG19/ayushG19/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
